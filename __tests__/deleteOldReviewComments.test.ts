...
test('deleteOldReviewComments works', async function () {
  ...
  (octokit.pulls.listReviewComments as unknown as jest.Mock).mockImplementation(
    () => ({
      data: [
        {
          url: 'https://api.github.com/repos/getsentry/sentry/pulls/comments/529164440',
          ...
          _links: {
            self: {
              href: 'https://api.github.com/repos/getsentry/sentry/pulls/comments/529164440',
            },
            html: {
              href: 'https://github.com/getsentry/sentry/pull/22253#discussion_r529164440',
            },
            pull_request: {
